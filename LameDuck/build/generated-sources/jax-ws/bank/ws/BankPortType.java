...
public interface BankPortType {
    ...
    @RequestWrapper(localName = "chargeCreditCard", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "bank.ws.ChargeCreditCard")
    @ResponseWrapper(localName = "chargeCreditCardResponse", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "bank.ws.ChargeCreditCardResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "validateCreditCard", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "bank.ws.ValidateCreditCard")
    @ResponseWrapper(localName = "validateCreditCardResponse", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "bank.ws.ValidateCreditCardResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "refundCreditCard", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "bank.ws.RefundCreditCard")
    @ResponseWrapper(localName = "refundCreditCardResponse", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "bank.ws.RefundCreditCardResponse")
