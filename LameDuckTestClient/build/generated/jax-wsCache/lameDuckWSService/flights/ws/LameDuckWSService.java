 ...
 * 
 */
@WebServiceClient(name = "lameDuckWSService", targetNamespace = "http://lameDuck/web", wsdlLocation = "http://localhost:8080/LameDuck/lameDuckWSService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/LameDuck/lameDuckWSService?wsdl");
