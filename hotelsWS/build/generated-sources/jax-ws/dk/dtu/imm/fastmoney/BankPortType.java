...
public interface BankPortType {
    ...
    @RequestWrapper(localName = "chargeCreditCard", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "dk.dtu.imm.fastmoney.ChargeCreditCard")
    @ResponseWrapper(localName = "chargeCreditCardResponse", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "dk.dtu.imm.fastmoney.ChargeCreditCardResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "validateCreditCard", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "dk.dtu.imm.fastmoney.ValidateCreditCard")
    @ResponseWrapper(localName = "validateCreditCardResponse", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "dk.dtu.imm.fastmoney.ValidateCreditCardResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "refundCreditCard", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "dk.dtu.imm.fastmoney.RefundCreditCard")
    @ResponseWrapper(localName = "refundCreditCardResponse", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "dk.dtu.imm.fastmoney.RefundCreditCardResponse")
