...
public interface BankPortType {
    ...
    @RequestWrapper(localName = "chargeCreditCard", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "hotels.ws.ChargeCreditCard")
    @ResponseWrapper(localName = "chargeCreditCardResponse", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "hotels.ws.ChargeCreditCardResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "validateCreditCard", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "hotels.ws.ValidateCreditCard")
    @ResponseWrapper(localName = "validateCreditCardResponse", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "hotels.ws.ValidateCreditCardResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "refundCreditCard", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "hotels.ws.RefundCreditCard")
    @ResponseWrapper(localName = "refundCreditCardResponse", targetNamespace = "http://fastmoney.imm.dtu.dk", className = "hotels.ws.RefundCreditCardResponse")
